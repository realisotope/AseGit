...
if not fs.isDirectory(mainRepoDir) then fs.makeDirectory(mainRepoDir) end
...
-- --- Helper for Settings/Min/Max Button ---
...
local function refreshContext()
    ...
    if listener_obj and spr then
        spr.events:off(listener_obj)
    end
